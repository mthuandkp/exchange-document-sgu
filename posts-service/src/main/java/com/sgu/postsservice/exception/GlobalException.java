...
public class GlobalException extends ResponseEntityExceptionHandler {
    ...
    public ResponseEntity<HttpResponseEntity> handleNoContentException(NoContentException ex) {
        HttpResponseEntity httpResponseEntity = HttpResponseEntity.builder()
                .code(HttpStatus.CONFLICT.value())
                .message(ex.getMessage())
                .build();
    ...
    public ResponseEntity<HttpResponseEntity> handleNoContentException(UnAuthorizationException ex) {
        HttpResponseEntity httpResponseEntity = HttpResponseEntity.builder()
